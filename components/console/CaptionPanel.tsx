...
export default function CaptionPanel({
  ...
  return (
    <div className="h-full md:h-auto md:flex-1 flex flex-col bg-white dark:bg-[#212121] border-r border-gray-200 dark:border-gray-700">
      {/* Panel Header */}
                  ...
                  {(() => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="hidden lg:inline whitespace-nowrap">{buttonText}</span>
                      </button>
                    )
                  })()}
