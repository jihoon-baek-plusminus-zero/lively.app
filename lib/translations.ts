...
export const translations = {
  ...
  'auth.verify.title': {
    ...
    ja: 'メール認証が必要です',
    zh: '需要邮箱验证',
    es: 'Se requiere verificación de correo',
  },
  'auth.verify.message': {
    ko: '기재하신 이메일로 인증 메일이 발송되었습니다. 메일을 인증한 후 가입 절차를 완료하세요.',
    en: 'A verification email has been sent to your inbox. Please verify your email to complete the signup process.',
    ja: '確認メールが送信されました。メールを確認して登録手続きを完了してください。',
    zh: '验证邮件已发送。请验证您的邮箱以完成注册流程。',
    es: 'Se ha enviado un correo de verificación. Por favor, verifique su correo para completar el registro.',
  },
  'auth.verify.check.email': {
    ko: '만일 이메일을 확인할 수 없다면 메일 주소를 제대로 기재하였는지 확인해주세요.',
    en: 'If you cannot find the email, please check if you entered the correct email address.',
    ja: 'メールが見つからない場合は、正しいメールアドレスを入力したか確認してください。',
    zh: '如果找不到邮件，请检查您是否输入了正确的邮箱地址。',
    es: 'Si no encuentra el correo, verifique que haya ingresado la dirección correcta.',
  },
  'auth.verify.back.home': {
    ko: '홈으로 돌아가기',
    en: 'Back to Home',
    ja: 'ホームに戻る',
    zh: '返回首页',
  ...
  'auth.reset.subtitle': {
    ko: '가입하신 이메일 주소를 입력하시면 비밀번호 재설정 링크를 보내드립니다.',
    en: 'Enter your email address and we will send you a password reset link.',
    ja: '登録したメールアドレスを入力すると、パスワードリセットリンクをお送りします。',
    zh: '输入您的电子邮件地址，我们将向您发送密码重置链接。',
  ...
  'auth.reset.success': {
    ...
    ja: 'パスワードリセットリンクが送信されました！',
    zh: '密码重置链接已发送！',
    es: '¡Se ha enviado el enlace de restablecimiento de contraseña!',
  },
  'auth.reset.check.email': {
    ko: '이메일을 확인하고 링크를 클릭하여 비밀번호를 재설정하세요.',
    en: 'Please check your email and click the link to reset your password.',
    ja: 'メールを確認してリンクをクリックし、パスワードをリセットしてください。',
    zh: '请检查您的电子邮件并点击链接重置密码。',
    es: 'Por favor revisa tu correo electrónico y haz clic en el enlace para restablecer tu contraseña.',
  },
  'auth.back.to.login': {
    ko: '로그인으로 돌아가기',
    en: 'Back to Login',
  ...
  'auth.error.reset.failed': {
    ko: '비밀번호 재설정 요청에 실패했습니다. 등록된 이메일인지 확인해주세요.',
    en: 'Failed to request password reset. Please verify your email is registered.',
    ja: 'パスワードリセットリクエストに失敗しました。登録済みのメールアドレスか確認してください。',
    zh: '密码重置请求失败。请验证您的电子邮件是否已注册。',
    es: 'Error al solicitar restablecimiento de contraseña. Por favor verifica que tu correo electrónico esté registrado.',
  },
  'auth.update.password.title': {
    ko: '새 비밀번호 설정',
    en: 'Set New Password',
    ja: '新しいパスワードを設定',
    zh: '设置新密码',
  ...
  'auth.new.password.placeholder': {
    ko: '새 비밀번호를 입력하세요',
    en: 'Enter new password',
    ja: '新しいパスワードを入力',
    zh: '输入新密码',
    es: 'Ingresa nueva contraseña',
  },
  ...
  'auth.redirecting': {
    ko: '콘솔로 이동 중...',
    en: 'Redirecting to console...',
    ja: 'コンソールにリダイレクトしています...',
    zh: '正在重定向到控制台...',
    es: 'Redirigiendo a la consola...',
  },
